...
export default function Profile() {
 ...
 /*  const sendEmailNavigate = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-green-500 flex justify-center">
        {profileLoading ? (
          <LoadingComponent />
                            ...
                            <div className=" flex flex-col 2xl:block mt-10 min-w-0 flex-1">
                              ...
                              {isLoginUser && (
                                <Link
                                  ...
                                  className="inline-flex justify-center w-48 px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium roundFed-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                                >
                                  <UploadIcon
                      ...
                      <div className="w-full md:w-2/3 px-4 mb-4 md:mb-0">
                        <h1 className="text-center text-xl border-gray-500 mb-2 border-b-2">
                          {profile?.posts?.length >= 2 ? (
                            <h1>{profile?.posts?.length} Posts</h1>
                          ) : (
                            <h1>{profile?.posts?.length} Post</h1>
                          )}
                        </h1>
